...
function formatData(ohlc, volume, data) {
    ...
    $.each(data, function (i, v) {
        ...
        if (i == 0) {//第一笔的 红绿柱 判断依据是根据 今天开盘价与昨日收盘价比较
            ...
            percentageyAxisMin = Number(100 * ((v.price - yesterdayClose) / yesterdayClose));
            percentageyAxisMax = Number(100 * ((v.price - yesterdayClose) / yesterdayClose));
        ...
        percentageyAxisMin = percentageyAxisMin > Number(100 * ((v.price - yesterdayClose) / yesterdayClose)) ? Number(100 * ((v.price - yesterdayClose) / yesterdayClose)) : percentageyAxisMin;
        percentageyAxisMax = percentageyAxisMax > Number(100 * ((v.price - yesterdayClose) / yesterdayClose)) ? percentageyAxisMax : Number(100 * ((v.price - yesterdayClose) / yesterdayClose));
        ...
        ohlc.push({ x: dateUTC, y: Math.round(v.price * 100)/100 });
    ...
    chart = $(DIVID).highcharts('StockChart', {
        ...
        tooltip: {
            ...
            formatter: function () {
                ...
                if (newtime != "undefined" || newtime != undefined || newtime != "" || newtime != null) {
                    ...
                    if (volume > 10000) {
                        tip += "交易量：" + (volume * 0.0001).toFixed(2) + "(万手)<br/>";
                    } else {
                        tip += "交易量：" + volume + "(手)<br/>";
                    }
                    //if (amount > 1000) {
        ...
        },
        {
            ...
            labels: {
                ...
                formatter: function () {//涨跌幅
                    return (100 * ((this.value - yesterdayClose) / yesterdayClose)).toFixed(2) + "%";
                }
            },
            title: {
                text: ''
