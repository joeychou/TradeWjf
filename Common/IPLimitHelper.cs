...
namespace Common
{
    /// <summary>
    /// 站点IP访问频率限制 针对单个站点
    /// 参考：https://www.cnblogs.com/xuxiaoshuan/p/5845630.html
    /// </summary>
    public class IPLimitHelper
    {
        ...
        /// </summary> 
        private static int maxTimes = 4;

        /// <summary> 
        /// 一段时间长度（单位秒)，必须大于等于1 
        /// </summary> 
        private static int partSecond = 5;

        /// <summary> 
        /// 请求被拒绝是否加入请求次数 
        /// </summary> 
        private static bool isFailAddIn = true;

        static IPLimitHelper()
        {
        }

        /// <summary> 
        /// 设置时间，默认maxTimes=4, partSecond=5 
        /// </summary> 
