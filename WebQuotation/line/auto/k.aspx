<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="k.aspx.cs" Inherits="WebQuotation.line.auto.k" %>
...
<body style="padding: 0; margin: 2px">
    ...
    <script src="//js.zouhongsoft.com/scripts/js/k-data.js?rnd=201909091800"></script>
    <%}
        else
        { %>
    <script src="//js.zouhongsoft.com/highstock.js"></script>
