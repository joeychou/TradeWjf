...
<body style="margin: 0; padding: 0;">
    ...
    <script src="/scripts/js/absPainter.js"></script>
    <script src="/scripts/js/absPainterArea.js"></script>
    <script src="/scripts/js/util.js"></script>
    <script src="/scripts/js/absPainter.js"></script>
    <script src="/scripts/js/ajax.js"></script>
    <script src="/scripts/js/crossLines.js"></script>
    <script src="/scripts/js/axis-x.js"></script>
    <script src="/scripts/js/linepainter.js"></script>
    <script src="/scripts/js/linepainter_l.js"></script>
    <script src="/scripts/js/volumePainter.js"></script>
    <script src="/scripts/js/axis-y.js"></script>
    <script src="/scripts/js/chartEventHelper.js"></script>
    <script src="/scripts/js/t-data-black.js"></script>
    <!---->
