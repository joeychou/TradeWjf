<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kw.aspx.cs" Inherits="WebQuotation.line.black.kw" %>
...
<body onload="drawKL()" style="padding: 0; margin: 0px">
    ...
    <script src="/scripts/js/kw-data-s.js"></script>
    <script src="/scripts/libs/loading.js"></script>
    <script src="/scripts/libs/util.js"></script>
    <script src="/scripts/libs/absPainter.js"></script>
    <script src="/scripts/libs/ajax.js"></script>
    <script src="/scripts/libs/crossLines.js"></script>
    <script src="/scripts/libs/axis-x.js"></script>
    <script src="/scripts/libs/tip.js"></script>
    <script src="/scripts/libs/linepainter.js"></script>
    <script src="/scripts/libs/volumePainter.js"></script>
    <script src="/scripts/libs/axis-y.js"></script>
    <script src="/scripts/libs/chartEventHelper.kl.js?a2"></script>
    <script src="/scripts/libs/controller.js"></script>
