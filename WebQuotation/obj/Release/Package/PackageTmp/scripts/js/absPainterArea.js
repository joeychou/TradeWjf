...
function PainterArea(canvasId, paintImplement, data) {
...
PainterArea.prototype = {
    paint: function () {
        ...
        if (pctx.startArea) pctx.startArea.call(this);
        if (pctx.paintArea){
        	var dataLength = ((typeof pctx.getDataLength == 'function') ? pctx.getDataLength.call(this) : this.data.length);
        	var maxY = 0;
        	var maxX = 0;
            for (var i = 0; i < dataLength; i++) {
                ...
                var x1 = pctx.getX ? pctx.getX.call(this, dataLength-1) : undefined;
                var y1 = pctx.getY ? pctx.getY.call(this, dataLength-1) : undefined;
                pctx.paintArea.call(this, i, x, y , dataLength-1, x1, y1);
            }
        };
        if (pctx.endArea) pctx.endArea.call(this);
    },
